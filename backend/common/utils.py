...
def success_response(data: Dict[str, Any], status_code: int = 200,headers: Optional[Dict[str, Any]] = None ) -> JSONResponse:
    request_id = request_id_ctx.get(None)
    content = build_success(data, request_id=request_id)
