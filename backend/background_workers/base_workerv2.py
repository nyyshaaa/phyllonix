...
class BasePubSubWorker():
    def __init__(self, workers_count:int=2,max_queue_size: int = 1000):
        ...
        self._processed = 0
        self.subscribers={}
        self.handlers={"image_uploaded":ThumbnailTaskHandler(),"init_image_processing":ImageTransformHandler()}
    ...
    def register_subscribers(self):
        ...
        img_process_handler=self.handlers["init_image_processing"]
        self.subscribe("init_image_processing", img_process_handler.handle)
